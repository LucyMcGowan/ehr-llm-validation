...
make_flowchart(data_path = "~/Documents/ehr-llm-validation/data-raw/patient_data/ali_dat_original_roadmap.csv", 
               save_as = "~/Documents/ehr-llm-validation/figures/ehr_vs_original_flowchart_full_sample.png", 
               start_with_ehr = TRUE)
...
make_flowchart(data_path = "~/Documents/ehr-llm-validation/data-raw/patient_data/ali_dat_llm_nocontext_roadmap.csv", 
               save_as = "~/Documents/ehr-llm-validation/figures/ehr_vs_llm_nocontext_flowchart_full_sample.png", 
               start_with_ehr = TRUE)
...
make_flowchart(data_path = "~/Documents/ehr-llm-validation/data-raw/patient_data/ali_dat_llm_context_roadmap.csv", 
               save_as = "~/Documents/ehr-llm-validation/figures/ehr_vs_llm_context_flowchart_full_sample.png", 
               start_with_ehr = TRUE)
...
make_flowchart(data_path = "~/Documents/ehr-llm-validation/data-raw/patient_data/ali_dat_llm_context_clinician_roadmap.csv", 
               save_as = "~/Documents/ehr-llm-validation/figures/ehr_vs_llm_context_clinician_flowchart_full_sample.png", 
               start_with_ehr = TRUE)
