...
ggsave(filename = "~/Documents/ehr-llm-validation/figures/llm_context_vs_ehr_heatmap.png",
...
all_data |> 
  ...
  labs(x = "ICD-Supplemented Allostatic Load Index\nComponent (from the EHR)",
       y = "Validated Allostatic Load Index\nComponent (from Chart Review)") 
ggsave(filename = "~/Documents/ehr-llm-validation/figures/chart_vs_llm_context_heatmap.png",
       device = "png", width = 8, height = 4, units = "in")
