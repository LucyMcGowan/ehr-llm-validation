...
icd_dx = read.csv("~/Documents/ehr-llm-validation/data-raw/patient_data/dx_llm_context_loop_icd10_clinician_superset_roadmap.csv") |> 
  rename(matched_terms = matched_terms_llm_context_loop_icd10_clinician, 
...
all_dat |> 
  write.csv("~/Documents/ehr-llm-validation/data-raw/patient_data/ali_dat_llm_context_loop_icd10_clinician_roadmap.csv", 
            row.names = FALSE)
